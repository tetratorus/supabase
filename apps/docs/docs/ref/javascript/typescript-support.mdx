...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    To generate types for a hosted project, first [log in to the CLI](/docs/reference/cli/supabase-login) with `supabase login`. Without an authenticated session, `supabase gen types` fails to reach your project.
