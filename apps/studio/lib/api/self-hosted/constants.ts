...
// Dedicated password for POSTGRES_USER_READ_ONLY. Intentionally has no fallback:
// the read-only role must never share POSTGRES_PASSWORD.
export const POSTGRES_PASSWORD_READ_ONLY = process.env.POSTGRES_PASSWORD_READ_ONLY || ''
